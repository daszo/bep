...
Let $\mathcal{D} = \{d_1, d_2, \dots d_N \}$ denote the corpus of N documents, and let $\mathcal{Q} = \{q_1, q_2, \dots q_M \}$ represent the set of M queries. Further, we define $\mathcal{Y} = \{y_1, y_2, \dots y_N \}$ as the set of unique identifiers corresponding to each document. \\
