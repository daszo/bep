...
This chapter reviews prior work related to information retrieval methods relevant to this study. We first introduce traditional information retrieval approaches, including sparse lexical retrieval~\cite{strathprints2621, INR-019} and dense retrieval methods~\cite{karpukhin-etal-2020-dense, 2021arXiv210311943K}.  We then review generative retrieval (GR)~\cite{10.1145/3580305.3599903, NEURIPS2022_892840a6}, which forms the methodological focus of this work. Finally, we briefly introduce the Enron email corpus used in our experiments~\cite{klimt2004enron, klimt2004introducing}.
