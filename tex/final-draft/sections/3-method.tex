...
Model inference also uses top 10 trie-based greedy beam search, as specified in \cref{section:model_training}. Further, the same equation is used to score the retrieved docids \ref{eq:beam_scoring}and the trie that is traversed is build by the whole corpus: training, testing and validation. The testing set was used as a final test and to compare to with our bassline.
