...
\textbf{Scale comparison:} As shown in \textcite{10.1145/3580305.3599903} and \textcite{NEURIPS2022_892840a6}, we would expect DSI to improve from the 10k dataset to the 100k dataset. This however is not the case. DSI perfoms significantly worse. 
