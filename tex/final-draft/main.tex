...
\input{sections/6-conclusion & discussion}
% \input{tex/final-draft/sections/1-intro}
% \input{tex/final-draft/sections/2-related_work}
% \input{tex/final-draft/sections/3-method}
% \input{tex/final-draft/sections/4-settings}
% \input{tex/final-draft/sections/5-results}
% \input{tex/final-draft/sections/6-conclusion & discussion}
