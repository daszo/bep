...
Right before training the emails are truncated to x tokens as the model does not allow more. 
...
regex cleaning is brittle on natural data. Not all cleaning was succesfull \ref{app:compare}. Even after the research is over, artefacting is still present. A more robust way of cleaning is necessary to continue the use of the dataset for this task. 
